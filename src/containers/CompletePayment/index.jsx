...
const STATUS_CONTENT_MAP = {
  succeeded: {
    ...
    iconColor: `${(props) => props.theme.green}`,
    icon: SuccessIcon,
  ...
  processing: {
    ...
    iconColor: `${(props) => props.theme.gray10}`,
    icon: InfoIcon,
    buttonText: 'Pagamento em Processamento.',
    url: '/',
  },
  requires_payment_method: {
    text: 'Falha no pagamento, tente novamento',
    iconColor: `${(props) => props.theme.redHove}`,
    icon: ErrorIcon,
    buttonText: 'Pagamento em Processamento.',
    url: '/carrinho',
  },
